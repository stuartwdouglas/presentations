 ...
 * CLI commands to proxy /my-app to two other servers

----
/subsystem=undertow/configuration=handler/reverse-proxy=my-reverse-proxy:add
/subsystem=undertow/configuration=handler/reverse-proxy=my-reverse-proxy/host=ajp\:\/\/10.0.0.1\/my-app:add
/subsystem=undertow/configuration=handler/reverse-proxy=my-reverse-proxy/host=http\:\/\/10.0.0.2\/my-app:add
/subsystem=undertow/server=default-server/host=default-host/location=\/my-app:add(handler=my-reverse-proxy)
----
